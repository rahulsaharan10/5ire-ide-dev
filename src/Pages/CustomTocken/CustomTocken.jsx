...
function CustomTocken() {
  ...
  return (
    <div className={`scrollableCont`}>
      <MenuRestofHeaders FilterIcon backTo={"/manage"} title={"Add Custom Token"} />
